...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //Employee emp = new Employee(1,"John", "Merry", "111", 12, "144/12", "work", 1);
        //EmployeeTable.insertEmployee(dbHandler, emp);
       // Menu menu = new Menu(2, "hee", 1500);
       // MenuTable.insertMenu(dbHandler, menu);
        //SaleOrder order = new SaleOrder(1,10,15000,"work", 2, 1);
        ...
        Timestamp time = new Timestamp(1, logIn, logOut);
